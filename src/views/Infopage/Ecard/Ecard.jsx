...
import { CCard, CCardBody, CCardHeader, CCol, CFormGroup, CInput, CLabel, CRow, CSelect } from "@coreui/react"
...
const Ecard = (props) => {
    ...
    return (
        <div style={{display: props.display}}>
            ...
            <Button style={{marginRight:'15px'}} variant="contained"  disabled={props.activeStep === 0}  className={props.backButton} onClick={props.handleBack}>Yza</Button>
            <Button  variant="contained" color="primary"  onClick={submit}>Ýüzlenme ugratmak</Button>
